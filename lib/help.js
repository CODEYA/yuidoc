...
YUI.add('help', function (Y) {
    ...
    var help = [
        ...
        "",
        "Common Options:",
        "  -a, --addondir <directory path> Path that contains YUIDoc addon files.",
        "           An addon must export function like below code.",
        "           (example: yuidoc -a /path-to-yuidocjs/addons -t addon-example ...)",
        ...
        "  -T, --theme <simple|default|addon-example> Choose one of the built in themes (default is default)",
